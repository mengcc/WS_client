 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://myService.mzs.com/", wsdlLocation = "http://127.0.0.1:5200/myWs?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://myService.mzs.com/", "MyWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:5200/myWs?WSDL");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://myService.mzs.com/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myService.mzs.com/", "MyWebServicePort"), MyWebService.class, features);
    }
